...
@Gson.TypeAdapters
@Value.Immutable
public abstract class UpdateCertificate implements IamPermission {
    ...
    public Tuple2<IamAction, IamResource> getActionAndResource() {
        IamAction iamAction = new IamAction() {
            ...
            public String getIamString() {
                return SharedPermissions.IOT_UPDATE_CERTIFICATE;
            }
    ...
    public static class Builder extends ImmutableUpdateCertificate.Builder {
    }
}
