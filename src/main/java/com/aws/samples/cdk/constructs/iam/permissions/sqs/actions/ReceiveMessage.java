...
@Gson.TypeAdapters
@Value.Immutable
public abstract class ReceiveMessage implements IamPermission {
    ...
    public Tuple2<IamAction, IamResource> getActionAndResource() {
        IamAction iamAction = new IamAction() {
            ...
            public String getIamString() {
                return SharedPermissions.SQS_RECEIVE_MESSAGE;
            }
    ...
    public static class Builder extends ImmutableReceiveMessage.Builder {
    }
}
