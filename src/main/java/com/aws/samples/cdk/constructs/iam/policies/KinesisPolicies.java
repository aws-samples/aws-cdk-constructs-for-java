...
import com.aws.samples.cdk.constructs.iam.permissions.kinesis.resources.KinesisStream;
...
public class KinesisPolicies {
    ...
    public static PolicyStatement getPutRecordPolicyStatement(KinesisStream kinesisStream) {
